...
/* Userspace shim for <esunrpc/xprtmultipath.h>. Mirrors the real
 * struct layouts (vendor/esunrpc/include/esunrpc/xprtmultipath.h)
 * field-by-field so the SUT compiles + behaves identically. */
#ifndef _ESUNRPC_XPRTMULTIPATH_H
#define _ESUNRPC_XPRTMULTIPATH_H
...
struct rpc_xprt_iter {
    struct rpc_xprt_switch             *xpi_xpswitch;  /* __rcu in real */
...
extern struct rpc_xprt_switch *xprt_iter_xchg_switch(
    struct rpc_xprt_iter *xpi, struct rpc_xprt_switch *newswitch);
...
extern bool xprt_is_active(const struct rpc_xprt *xprt);
extern void xprt_iter_no_rewind(struct rpc_xprt_iter *xpi);
extern void xprt_iter_default_rewind(struct rpc_xprt_iter *xpi);

#endif /* _ESUNRPC_XPRTMULTIPATH_H */

...
size_t		esunrpc_rpc_ntop(const struct sockaddr *, char *, const size_t);
size_t		esunrpc_rpc_pton(struct net *, const char *, const size_t,
			 struct sockaddr *, const size_t);
char *		rpc_sockaddr2uaddr(const struct sockaddr *, gfp_t);
size_t		esunrpc_rpc_uaddr2sockaddr(struct net *, const char *, const size_t,
				   struct sockaddr *, const size_t);

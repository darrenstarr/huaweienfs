...
static inline void svcxdr_init_decode(struct svc_rqst *rqstp)
{
	...
	esunrpc_xdr_init_decode(xdr, buf, argv->iov_base, NULL);
...
static inline void svcxdr_encode_opaque_pages(struct svc_rqst *rqstp,
					      ...
					      unsigned int len)
{
	esunrpc_xdr_write_pages(xdr, pages, base, len);
...
static inline bool svcxdr_set_accept_stat(struct svc_rqst *rqstp)
{
	...
	rqstp->rq_accept_statp = esunrpc_xdr_reserve_space(xdr, XDR_UNIT);

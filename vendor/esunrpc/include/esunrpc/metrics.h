...
struct rpc_iostats *	esunrpc_rpc_alloc_iostats(struct rpc_clnt *);
void			esunrpc_rpc_count_iostats(const struct rpc_task *,
					  struct rpc_iostats *);
void			esunrpc_rpc_count_iostats_metrics(const struct rpc_task *,
					  struct rpc_iostats *);
void			esunrpc_rpc_clnt_show_stats(struct seq_file *, struct rpc_clnt *);
void			esunrpc_rpc_free_iostats(struct rpc_iostats *);

#else  /*  CONFIG_PROC_FS  */

static inline struct rpc_iostats *esunrpc_rpc_alloc_iostats(struct rpc_clnt *clnt) { return NULL; }
static inline void esunrpc_rpc_count_iostats(const struct rpc_task *task,
				     struct rpc_iostats *stats) {}
static inline void esunrpc_rpc_count_iostats_metrics(const struct rpc_task *task,
					     struct rpc_iostats *stats)
{
}

static inline void esunrpc_rpc_clnt_show_stats(struct seq_file *seq, struct rpc_clnt *clnt) {}
static inline void esunrpc_rpc_free_iostats(struct rpc_iostats *stats) {}

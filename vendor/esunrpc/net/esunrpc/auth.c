 ...
 */
const struct cred *esunrpc_rpc_machine_cred(void)
{
	return &machine_cred;
}
EXPORT_SYMBOL_GPL(esunrpc_rpc_machine_cred);
...
int
esunrpc_rpcauth_register(const struct rpc_authops *ops)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_register);

int
esunrpc_rpcauth_unregister(const struct rpc_authops *ops)
{
	const struct rpc_authops *old;
	rpc_authflavor_t flavor;
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_unregister);
...
/**
 * esunrpc_rpcauth_get_pseudoflavor - check if security flavor is supported
 ...
 */
rpc_authflavor_t
esunrpc_rpcauth_get_pseudoflavor(rpc_authflavor_t flavor, struct rpcsec_gss_info *info)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_get_pseudoflavor);

/**
 * esunrpc_rpcauth_get_gssinfo - find GSS tuple matching a GSS pseudoflavor
 ...
 */
int
esunrpc_rpcauth_get_gssinfo(rpc_authflavor_t pseudoflavor, struct rpcsec_gss_info *info)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_get_gssinfo);

struct rpc_auth *
esunrpc_rpcauth_create(const struct rpc_auth_create_args *args, struct rpc_clnt *clnt)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_create);
 ...
 */
int
esunrpc_rpcauth_init_credcache(struct rpc_auth *auth)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_init_credcache);

char *
esunrpc_rpcauth_stringify_acceptor(struct rpc_cred *cred)
{
	if (!cred->cr_ops->crstringify_acceptor)
		return NULL;
	return cred->cr_ops->crstringify_acceptor(cred);
}
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_stringify_acceptor);
 ...
 */
void
esunrpc_rpcauth_destroy_credcache(struct rpc_auth *auth)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_destroy_credcache);
 ...
 */
struct rpc_cred *
esunrpc_rpcauth_lookup_credcache(struct rpc_auth *auth, struct auth_cred * acred,
		int flags, gfp_t gfp)
{
	LIST_HEAD(free);
	struct rpc_cred_cache *cache = auth->au_credcache;
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_lookup_credcache);

struct rpc_cred *
esunrpc_rpcauth_lookupcred(struct rpc_auth *auth, int flags)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_lookupcred);

void
esunrpc_rpcauth_init_cred(struct rpc_cred *cred, const struct auth_cred *acred,
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_init_cred);
...
rpcauth_bind_new_cred(struct rpc_task *task, int lookupflags)
{
	...
	return esunrpc_rpcauth_lookupcred(auth, lookupflags);
}
...
void
esunrpc_put_rpccred(struct rpc_cred *cred)
{
	if (cred == NULL)
		return;
	rcu_read_lock();
...
EXPORT_SYMBOL_GPL(esunrpc_put_rpccred);
...
/**
 * esunrpc_rpcauth_wrap_req_encode - XDR encode the RPC procedure
 * @task: controlling RPC task
 ...
 */
int esunrpc_rpcauth_wrap_req_encode(struct rpc_task *task, struct xdr_stream *xdr)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_wrap_req_encode);
...
/**
 * esunrpc_rpcauth_unwrap_resp_decode - Invoke XDR decode function
 * @task: controlling RPC task
 ...
 */
int
esunrpc_rpcauth_unwrap_resp_decode(struct rpc_task *task, struct xdr_stream *xdr)
{
	kxdrdproc_t decode = task->tk_msg.rpc_proc->p_decode;

	return decode(task->tk_rqstp, xdr, task->tk_msg.rpc_resp);
}
EXPORT_SYMBOL_GPL(esunrpc_rpcauth_unwrap_resp_decode);

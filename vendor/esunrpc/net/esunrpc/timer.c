...
/**
 * esunrpc_rpc_init_rtt - Initialize an RPC RTT estimator context
 * @rt: context to initialize
 * @timeo: initial timeout value, in jiffies
 *
 */
void esunrpc_rpc_init_rtt(struct rpc_rtt *rt, unsigned long timeo)
{
...
EXPORT_SYMBOL_GPL(esunrpc_rpc_init_rtt);

/**
 * esunrpc_rpc_update_rtt - Update an RPC RTT estimator context
 ...
 */
void esunrpc_rpc_update_rtt(struct rpc_rtt *rt, unsigned int timer, long m)
{
	long *srtt, *sdrtt;
...
EXPORT_SYMBOL_GPL(esunrpc_rpc_update_rtt);

/**
 * esunrpc_rpc_calc_rto - Provide an estimated timeout value
 ...
 * other                   - timeo
 */
unsigned long esunrpc_rpc_calc_rto(struct rpc_rtt *rt, unsigned int timer)
{
	unsigned long res;
...
EXPORT_SYMBOL_GPL(esunrpc_rpc_calc_rto);
